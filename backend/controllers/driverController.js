...
const createDriver = async (req, res) => {
  try {
    ...
    if (!name) {
      return res
        .status(400)
        .json({ message: "Please provide a name for the driver." });
    }
...
const updateDriver = async (req, res) => {
  try {
    ...
    driver.currentShiftHours =
      req.body.currentShiftHours ?? driver.currentShiftHours;
    driver.past7DayWorkHours =
      req.body.past7DayWorkHours || driver.past7DayWorkHours;
